...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numThreads; i++) {
            ...
            List<String[]> subList = COORDINATES.subList(start, end);
            Thread thread = new Thread(() -> buscarDadosClimaticos(subList, mapaDadosClimaticos));
            threads.add(thread);
            thread.start();
        }
    ...
    private static void buscarDadosClimaticos(List<String[]> coordinates, Map<String, dadosClimaticos> mapaDadosClimaticos) {
